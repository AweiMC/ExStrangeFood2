package team.teampotato.exstrangefood2.ArmorMaterials;
...
public enum ArmorMaterials implements ArmorMaterial {
    //铜
        COPPER("copper", 7, new int[]{2, 5, 6, 2}, 12, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> {
            return Ingredient.ofItems(new ItemConvertible[]{Items.COPPER_INGOT});
        }),
    //高级合金
    EXSFSYNCRETIC("exstrangefood", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F, 0.0F, () -> {
            return Ingredient.ofItems(new ItemConvertible[]{Items.NETHER_STAR});
        }),
    //紫水晶
        AMETHYSTSHARD("amethystshard", 25, new int[]{2, 5, 6, 2}, 20, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0.0F, 0.0F, () -> {
